<?php namespace App\Http\Controllers;
	...
	class AdminWeedmapsProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Listing Id","name"=>"listing_id","join"=>"weedmaps_dispensaries,name"];
			...
			$this->form[] = ['label'=>'Grams Per Eighth','name'=>'grams_per_eighth','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Listing Id','name'=>'listing_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'weedmaps_dispensaries,name'];
			$this->form[] = ['label'=>'Prices','name'=>'prices','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Image Url','name'=>'image_url','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Thumb Image Url','name'=>'thumb_image_url','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Category Id','name'=>'category_id','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Vendor Id','name'=>'vendor_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'weedmaps_brands,name'];
			$this->form[] = ['label'=>'Vendor Name','name'=>'vendor_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Vendor Slug','name'=>'vendor_slug','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Name Processed','name'=>'name_processed','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
