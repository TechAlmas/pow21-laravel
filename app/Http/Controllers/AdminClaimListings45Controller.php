<?php namespace App\Http\Controllers;
	...
	class AdminClaimListings45Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Listing Id","name"=>"listing_id","join"=>"listing,id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Listing Id','name'=>'listing_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'listing,id'];
			...
			$this->form[] = ['label'=>'Files','name'=>'files','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Listing Id","name"=>"listing_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"listing,id"];
			...
			//$this->form[] = ["label"=>"E Mail","name"=>"e_mail","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Verification Details","name"=>"verification_details","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Files","name"=>"files","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
