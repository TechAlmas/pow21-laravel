<?php namespace App\Http\Controllers;
	...
	class AdminMasterDispensaryReviewsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Disp Name","name"=>"disp_id","join"=>"master_locations,name"];
			...
			$this->form[] = ['label'=>'Disp Id','name'=>'disp_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'master_locations,name'];
			...
			//$this->form[] = ["label"=>"Disp Id","name"=>"disp_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"disp,id"];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:master_dispensary_reviews","placeholder"=>"Please enter a valid email address"];
