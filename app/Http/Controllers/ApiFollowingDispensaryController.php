<?php namespace App\Http\Controllers;
		...
		class ApiFollowingDispensaryController extends \crocodicstudio\crudbooster\controllers\ApiController {

		    function __construct() {    
				$this->table       = "master_dispensary_followers";        
				$this->permalink   = "following_dispensary";    
		    ...
		    public function hook_after($postdata,&$result) {
				...
				$dispansary = DB::table('master_dispensary_followers')
									...
									->select('master_dispensary_followers.created_at as created_at',
									            'master_locations.id as id','master_locations.name as name','master_locations.address as address',
												'master_locations.address2 as address2','master_locations.city as city',
												'master_locations.state as state','master_locations.zip_code as zip_code','master_locations.country as country',
												'master_locations.website as website','master_locations.email as email2','master_locations.phone as phone',
												'master_locations.source as source','master_locations.city_id as city_id','master_locations.state_id as state_id',
												'master_locations.logoUrl as logoUrl','master_locations.description as description','master_locations.ratings as ratings',
												'master_locations.reviews as reviews','master_locations.schedule as schedule',
												'master_locations.license_type as license_type','master_locations.status as status',
												'master_locations.updated_at as updated_at','master_locations.slug as slug',
