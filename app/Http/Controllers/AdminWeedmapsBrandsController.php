<?php namespace App\Http\Controllers;
	...
	class AdminWeedmapsBrandsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Web Url","name"=>"web_url"];
