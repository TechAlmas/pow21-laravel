...
<div class='table-responsive'>
    <table id='table-detail' class='table table-striped'>
        ...
        if($form['name'] == "model_sel" || $form['name'] == "year_sel" || $form['name'] == "trim_sel"){
            continue;
        }
        ...
        <?php endforeach;?>
        <tr>
            <td>Favourite Strain</td>
            <td><a href="{{url('/admin/users-favourite-strains?q='.$row->name)}}" target="_blank">view</a></td>
        </tr>
        <tr>
            <td>Price Alert</td>
            <td><a href="{{url('/admin/users-price-alerts?q='.$row->name)}}" target="_blank">view</a></td>
        </tr>
        <tr>
            <td>Target PriceAlert</td>
            <td><a href="{{url('/admin/users-target-price-alert?q='.$row->name)}}" target="_blank">view</a></td>
        </tr>
    </table>
</div>
@endsection