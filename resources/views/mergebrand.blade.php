...
@section("content")
  <!-- Your html goes here -->
  <div>	
	  <p><a title="Return" href="{{CRUDBooster::mainpath()}}"><i class="fa fa-chevron-circle-left "></i>&nbsp; Back To List Data Master Missing Strains</a></p>

	  <div class='panel panel-default'>

	  	<div class="panel-heading">
            <strong><i class="fa fa-th-list"></i> Merge Brand</strong>
        </div>	   
	    <div class='panel-body' style="padding: 20px 0px 0px 0px;">
	      <form class="form-horizontal" method='post' action='{{CRUDBooster::mainpath("save-to-master-brand")}}'>
	        ...
	        <div class="box-body" id="parent-form-area">
		        ...
		        <div class='form-group header-group-0 '>
		          <label class="control-label col-sm-2">Merge to Brand</label>
		          <div class="col-sm-10">
		          		<select class="form-control" name="own_id" id="own_id" required="required">
		          				<option value="0"></option>
		          			@foreach ($master_brands as $stn)
